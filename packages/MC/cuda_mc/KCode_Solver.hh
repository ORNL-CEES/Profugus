...
#ifndef cuda_mc_KCode_Solver_hh
#define cuda_mc_KCode_Solver_hh
...
/*!
 * \class KCode_Solver
 * \brief Solve an eigenvalue problem using the CUDA_MC K-Code method.
 *
 ...
 *
 * The database entries that control the cuda_profugus::KCode_Solver are:
 *
 ...
 */
/*!
 * \example cuda_mc/test/tstKCode_Solver.cc
 *
