//----------------------------------*-C++-*----------------------------------//
/*!
 * \file   cuda_mc/Fission_Rebalance.cc
 * \author Steven Hamilton
 * \date   Monday May 5 11:37:31 2014
 * \brief  Fission_Rebalance member definitions.
 ...
 */
void Fission_Rebalance::communicate(
        Fission_Site_Container_t &fission_bank)
{
    ...
    // post receives
    post_receives(num_recv_left, recv_left, d_left, d_handle_left, 303);
    post_receives(num_recv_right, recv_right, d_right, d_handle_right, 304);
    ...
    // receive sites
    receive(num_recv_left, fission_bank, recv_left, d_left, d_handle_left,
            303);
    receive(num_recv_right, fission_bank, recv_right, d_right,
            d_handle_right, 304);
