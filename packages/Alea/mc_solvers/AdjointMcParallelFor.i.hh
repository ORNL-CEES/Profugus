...
namespace
{
    ...
    const SCALAR * lower_bound2(const SCALAR * first,
                               const SCALAR * last,
                               SCALAR val)
    {
        const SCALAR *it;
 ...
 */
//---------------------------------------------------------------------------//
AdjointMcParallelFor::AdjointMcParallelFor(const const_view_type                H,
                                           ...
                                           generator_type &gen) const
{
    ...
    const SCALAR * const elem = lower_bound2(cdf,cdf+cdf_length,rand);
