//----------------------------------*-C++-*----------------------------------//
/*!
 * \file   spn_tpetra/Solver_Base.hh
...
#ifndef spn_tpetra_Solver_Base_hh
#define spn_tpetra_Solver_Base_hh
 ...
 */
/*!
 * \example spn_tpetra/test/tstSolver_Base.cc
 *
 * Test of Solver_Base.
 */
//===========================================================================//
...
class Solver_Base
{
  public:
    ...
    typedef Teuchos::RCP<const Linear_System_t> RCP_Const_Linear_System;
  ...
  public:
    ...
    RCP_Const_Linear_System get_linear_system() const { return b_system; }
...
#endif // spn_tpetra_Solver_Base_hh
