...
\
-DCMAKE_CXX_FLAGS:STRING="--c++11 -V14.7 -w -D_X86INTRIN_H_INCLUDED" \
...
-DHDF5_INCLUDE_DIRS:PATH=$CRAY_HDF5_DIR/pgi/121/include \
-DHDF5_LIBRARY_DIRS:PATH=$CRAY_HDF5_DIR/pgi/121/lib \
\
